...
//        System.out.println(response.body().string());
        ...
        String contentHead = "{\n  \"state\": \"{\\\"queryParam\\\":{},\\\"record\\\":{},\\\"auctionCode\\\":\\\"";
        String auctionCode = "A20190803125603000241";
        String contentHail = "\\\",\\\"cancelReason\\\":\\\"test\\\"}\",\n  \"props\": \"{}\"\n}";
        String contend = contentHead + auctionCode + contentHail;
        ...
        Request request2 = new Request.Builder()
                ...
                .post(body2)
//                .addHeader("JESSIONID", "7BEBC334BD1F5F7636764CDE5D60969C")
                .addHeader("_security_token_inc", "91565006388650177")
                .addHeader("Content-Type", "application/json")
                .addHeader("cache-control", "no-cache")
                .build();
